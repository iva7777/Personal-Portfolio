<template>
    <section id="portfolio" class="min-h-screen flex flex-col items-center justify-center p-8">
        ...
        <a href="https://heyzine.com/flip-book/c182baee69.html" target="_blank"
            class="inline-block px-6 py-2 mt-10 capitalize rounded-full bg-gradient-to-r from-purple-600 to-purple-800 text-white font-semibold shadow-lg hover:scale-105 hover:shadow-purple-500 transition-transform duration-300">See the whole book
        </a>
    </section>
</template>